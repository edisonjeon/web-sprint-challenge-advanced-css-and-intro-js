...
/* having serious trouble understanding a key concept, do i need to convert the strings to a numbers and if so, how do i define those parameters? */

function get20s(array){
  let newArray = [];
  Number(array[i].years);
...
function addArtist(array){
    array.push({id: 20, years: 1993 - 2021, genre: 'Web Design', nationality: 'Korean American', bio: 'Here is my bio.'});
    return array;
  }
